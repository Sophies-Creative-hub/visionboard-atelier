...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen text-white overflow-hidden flex flex-col relative selection:bg-violet-300">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-50 flex flex-col items-center gap-4 w-full max-w-md pointer-events-none exclude-from-export">
